...
def parameter_parser():
    ...
    parser.add_argument("--dimensions", type=int, default=16, help="Number of dimensions. Default is 128.")
    #parser.add_argument("--epochs", #type=int, #default=200, #help="Number of gradient descent iterations. Default is 200.")
